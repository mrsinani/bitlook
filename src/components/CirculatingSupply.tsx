...
import { RefreshCw, DatabaseIcon, AlertCircle, AlertTriangle } from 'lucide-react';
...
const CirculatingSupply = ({ refreshInterval = 60000 }: CirculatingSupplyProps) => {
  const { data, loading, error, refetch, isFromCache } = useBitcoinSupply(refreshInterval);
        ...
        {loading && !data ? (
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <Progress value={Number(getPercentMined())} className="h-2" />
            </div>
