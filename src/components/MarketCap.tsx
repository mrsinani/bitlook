...
const MarketCap = ({ refreshInterval = 60000 }: MarketCapProps) => {
  const { data, loading, error, refetch, isFromCache } = useBitcoinMarketData(refreshInterval);
        ...
        {loading && !data ? (
          ...
          <div className="text-center">
            ...
            {data.priceChange24h !== 0 && (
              <div className={`mt-2 text-sm ${data.priceChange24h > 0 ? 'text-green-500' : 'text-red-500'}`}>
